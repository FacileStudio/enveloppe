...
pseudo-version; Sablier and Mycelium are both on `v0.0.0-20260804090730-02b0f4b20c6f`. A push to
...
`feat: agent_session object + Mycelium app for agent time tracking`,
...
non-breaking for Mycelium, which always supplies one.
